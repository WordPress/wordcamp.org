...
<ul class="wcb-form">
	<li>
		<label for="_wcbsi_sponsor_id">
			<?php esc_html_e( 'Sponsor:', 'wordcamporg' ); ?>
		</label>
		...
		<div class="wcb-form-input-wrapper">
			...
			<select id="_wcbsi_sponsor_id" name="_wcbsi_sponsor_id" required>
				<option value="">
					<?php esc_html_e( '-- Select a Sponsor --', 'wordcamporg' ); ?>
				</option>
	...
	<li>
		<label for="_wcbsi_qbo_class_id">
			<?php esc_html_e( 'Community:', 'wordcamporg' ); ?>
		</label>

		<div class="wcb-form-input-wrapper">
			<select id="_wcbsi_qbo_class_id" name="_wcbsi_qbo_class_id" required>
				<option value="">
					<?php esc_html_e( '-- Select a Community --', 'wordcamporg' ); ?>
				</option>
