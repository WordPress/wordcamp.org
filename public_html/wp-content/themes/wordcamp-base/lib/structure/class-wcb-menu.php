	...
	function content() { ?>
		<div id="<?php echo $this->get_id(); ?>" class="grid_12">
			<div id="access" role="navigation" class="clearfix">
				...
				<h3 class="menu-toggle"><?php esc_html_e( 'Menu', 'wordcamporg' ); ?></h3>
				<?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'wordcamporg' ); ?>"><?php esc_html_e( 'Skip to content', 'wordcamporg' ); ?></a></div>
