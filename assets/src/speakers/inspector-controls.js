...
class SpeakerInspectorControls extends Component {
	render() {
		...
		return (
			<InspectorControls>
				<PanelBody title={__('Which Speakers?', 'wordcamporg')}
						   initialOpen={true}>
					<PanelRow>
						<CheckboxControl
				...
				<PanelBody title={__('Speaker Display', 'wordcamporg')}
						   initialOpen={false}>
					<PanelRow>
						<CheckboxControl
							label={__('Link titles to single posts',
								'wordcamporg')}
