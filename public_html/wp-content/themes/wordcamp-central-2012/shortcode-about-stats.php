<ul class="about-stats clearfix">
	...
	<li>
		<span class="about-stat-number"><?php echo esc_html( $map_stats['countries'] ); ?></span>
		<span class="about-stat-descriptor">Countries</span>
	</li>

	<li>
		<span class="about-stat-number"><?php echo esc_html( $map_stats['continents'] ); ?></span>
		<span class="about-stat-descriptor">Continents</span>
	</li>
</ul>
