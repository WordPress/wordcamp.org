...
<fieldset <?php disabled( $box['args']['fields_enabled'], false ); ?> >
	...
	<table class="form-table">
		<?php if ( $box['args']['show_vendor_requested_payment_method'] ) : ?>
			<?php $this->render_textarea_input( $post, esc_html__( 'Did the vendor request a specific type of payment?', 'wordcamporg' ), 'vendor_requested_payment_method', esc_html__( 'Add any relevant details', 'wordcamporg' ), false ); ?>
		<?php endif;?>
