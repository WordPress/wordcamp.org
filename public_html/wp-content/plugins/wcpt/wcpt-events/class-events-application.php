...
namespace WordPress_Events\Applications;
...
/*
		Organizer Information
			- First Name: [Required]
			- Last Name: [Required] 'First Name' + 'Last Name' together populate the 'Organizer Name' field
			- Email Address: [Required] Populates the 'Email Address' field
			- WordPress.org Username: [Required] Populates the 'WordPress.org Username' field
			- Making WordPress Slack Username:
			- City/State/Country of Residence: [Required]
			- Is there a WordPress meetup in your community? If so, please share the URL:
			- Have you attended a WordPress Meetup, WordCamp, or other WordPress event? [Required]
		...
		Event Information
			- Event city and country: [Required] Populates the 'Location' field
			- Event date(s): [Required]
			- Is this event in-person or online? [Required] [Multiple Choice]
				- In-person
				- Online If 'Online' is selected, check the 'Virtual event only' box under 'Venue Information' (but if this is complicated, don't worry about it)
				- Hybrid
			- Please describe the event you would like to organize: [Required]
			- What goals do you want to achieve with this event? [Required]
			- Which of the following describe this event? [Select all that apply]
				- Activity focused (training, recruiting, networking, contributing, conferencing, etc.)
				- Topic focused (design, development, security, accessibility, SEO, agencies, marketing, etc.)
				- Identity focused (WordPress for Students, WordPress for Women, BlackPress, etc.)
				- Job-status focused (job seekers, freelancers, business owners, etc)
				- For a specific expertise level (beginners, intermediate, advanced users)
				- Sustainable event (no swag, small/easy to organize, low budget, etc.)
				- Other (please specify)
			- Approximate number of attendees: [Required] Populates the 'Number of Anticipated Attendees' box
			- If you have co-organizers, please share their name(s), email address(es) and WordPress.org username(s).
			- Your event URL will be: https://events.wordpress.org/[location]/[year]/[eventname]
				- For example: https://events.wordpress.org/narnia/2024/communityday
			...
			- What is the estimated cost to organize your event? [Required]
			- Are you confident you can raise money from local sponsors? Please explain. [Required]
						...
						<div class="PDF_QT400">
							<ul>
								...
								<li>
									...
									<label for="q_1068246_1908778">I help other people use WordPress for their
										websites</label>
								</li>
								<li>
								...
								<li>
									...
									<label for="q_1068246_1908833">I volunteer in the support forums at
										wordpress.org</label>
								</li>
								<li>
					...
					<div class="qContent">
						...
						<div class="PDF_QT200">
							<textarea name="q_1046033_camps_been_to" class="small" rows="10" cols="40"
									  title="What WordCamps have you been to? Please list one pe&hellip;"></textarea>
						</div>
					</div>
				</div>
						...
						<div class="PDF_QT400">
							<ul>
								...
								<li>
									...
									<label for="q_1068223_1908731">Introduce new people to WordPress/teach new
										users</label>
								</li>
								<li>
								...
								<li>
									...
									<label for="q_1068223_1908772">Make connections with visiting speakers (like Matt
										Mullenweg)</label>
								</li>
								<li>
									...
									<label for="q_1068223_1908773">Make money from surplus ticket
								...
								<li>
									...
									<label for="q_1068223_1908775">Be part of the zeitgeist, as WordCamps are very
					...
					<div class="qContent">
						...
						<div class="PDF_QT200">
							<textarea name="q_1079082_other_tech_events_success" class="small" rows="10" cols="40"
									  title="List any community tech events that have/have not b&hellip;"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="qContent">
						...
						<div class="PDF_QT100">
							<input value="" maxlength="500" name="q_1079103_wordcamp_location" class="large required"
								   type="text" title="Enter the city, state/province, and country where y&hellip;"
								   required/>
						</div>
					</div>
				</div>
					...
					<div class="qContent">
						...
						<div class="PDF_QT100">
							<input value="" maxlength="500" name="q_1046006_wordcamp_date" class="large" type="text"
								   title="When do you want to have a WordCamp in your city? (&hellip;"/>
						</div>
					</div>
				</div>
					...
					<div class="qContent">
						...
						<div class="PDF_QT200">
							<textarea name="q_1046099_describe_events" class="small" rows="10" cols="40"
									  title="Please give a brief description of the events you&#039;v&hellip;"></textarea>
						</div>
					</div>
				</div>
						...
						<div class="PDF_QT400">
							<ul>
								...
								<li>
									...
									<label for="q_1068188_1908689">We met through the meetup group/other tech
										event</label>
								</li>
								<li>
					...
					<div class="qContent">
						...
						<div class="PDF_QT200">
							<textarea name="q_1068187_co_organizer_contact_info" class="small" rows="10" cols="40"
									  title="Please enter the names and email addresses of your &hellip;"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="qContent">
						...
						<div class="PDF_QT100">
							<input value="" maxlength="500" name="q_1068220_interested_sponsors" class="large"
								   type="text" title="If there are businesses already interested in spons&hellip;"/>
						</div>
					</div>
				</div>
					...
					<div class="qContent">
						...
						<div class="PDF_QT200">
							<textarea name="q_1046021_presenter_names" class="small" rows="10" cols="40"
									  title="Please enter the names of the people you have in mi&hellip;"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="qContent">
						...
						<div class="PDF_QT200">
							<textarea name="q_1079098_anything_else" class="large" rows="10" cols="40"
									  title="Anything else you want us to know while we&#039;re looki&hellip;"></textarea>
						</div>
					</div>
				</div>
