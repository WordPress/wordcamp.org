				...
				>
					...
					<ToggleControl
						...
						help={
							show_meta
								? __(
										'Date, time, and track are visible.',
										'wordcamporg'
								  )
								: __(
										'Date, time, and track are hidden.',
										'wordcamporg'
								  )
						}
						checked={ show_meta === undefined ? false : show_meta }
						onChange={ ( value ) =>
							setAttributes( { show_meta: value } )
						}
					/>
					<ToggleControl
						...
						help={
							show_category
								? __(
										'Session categories are visible.',
										'wordcamporg'
								  )
								: __(
										'Session categories are hidden.',
										'wordcamporg'
								  )
						}
						checked={
							show_category === undefined ? false : show_category
						}
						onChange={ ( value ) =>
					...
					<ToggleControl
						...
						help={
							show_speaker
								? __(
										'Session speakers are visible.',
										'wordcamporg'
								  )
								: __(
										'Session speakers are hidden.',
										'wordcamporg'
								  )
						}
						checked={
							show_speaker === undefined ? false : show_speaker
						}
						onChange={ ( value ) =>
							setAttributes( { show_speaker: value } )
						}
					/>
				</PanelBody>
