 ...
 * Inserter: no
 *
 * Renders an "← All events" link that resolves to the registered event
 * archive. Used at the top of single-event and single-venue templates so the
 * link works on path-based multisite installs.
 *
